            ...
            <ul class="navbar-list">
                <li>
                    <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center">
                        ...
                        <div class="caption">
                            <h6 class="mb-0 line-height text-capitalize">{{firstName}} {{lastName}}</h6>
                            <span class="font-size-12">{{userEmail}}</span>
                        </div>
                    </a>
                    <div class="iq-sub-dropdown iq-user-dropdown">
                        <div class="iq-card shadow-none m-0">
                            <div class="iq-card-body p-0 ">
                                <div class="bg-primary p-3">
                                    <h5 class="mb-0 text-white line-height text-capitalize">Hello {{firstName}} {{lastName}} </h5>
                                    <span class="text-white font-size-12">{{userEmail}}</span>
                                </div>
                                ...
                                <a href="account-setting.html" class="iq-sub-card iq-bg-primary-hover">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body ml-3">
                                            ...
                                            <p class="mb-0 font-size-12">Complete your account setup</p>
                                        </div>
                                    </div>
                                </a>
                                ...
                                <div class="d-inline-block w-100 text-center p-3">
                                    <a class="bg-primary iq-sign-btn" href="" @click.prevent="onLogout()" role="button">Sign out<i class="ri-login-box-line ml-2"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
