...
<!--side bar-->
<div class="iq-sidebar" style="background-color: rgba(8, 155, 171, 1)">
    <div class="iq-sidebar-logo d-flex justify-content-between">
        <a href="index.html">
            <img src="/images/logo/logo4.svg" class="img-fluid" alt="">
            <span>CIDRA</span>
        </a>
    ...
    <div id="sidebar-scrollbar">
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                ...
                <li>
                    <a href="/AdminDashboard" class="iq-waves-effect" ><i
                                class="ri-group-fill"></i><span>Admin Dashboard</span></a>
                </li>
                <li>
                    <a href="covid.php" class="iq-waves-effect"><i class="ri-virus-fill"></i><span>Covid-19 Dashboard</span><span
                                class="badge badge-danger">New</span></a>
                </li>
                <li class="iq-menu-title"><i class="ri-subtract-line"></i><span>Apps</span></li>
                <li>
                    <a href="#mailbox" class="iq-waves-effect collapsed" data-toggle="collapse"
                       aria-expanded="false"><i class="ri-mail-open-fill"></i><span>Email</span><i
                ...
                <li>
                    <a href="#hospital-info" class="iq-waves-effect collapsed" data-toggle="collapse"
                       aria-expanded="false"><i class="ri-user-3-fill"></i><span>Hospitals</span><i
                                class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                    <ul id="hospital-info" class="iq-submenu collapse bg-white" data-parent="#iq-sidebar-toggle">
                        <li><a href="/ListHospital"><i class="ri-file-list-fill"></i>List Hospital</a></li>
                        <li><a href="add-doctor.html"><i class="ri-user-add-fill"></i>Add Hospital</a></li>
                        <li><a href="profile.html"><i class="ri-profile-fill"></i>Hospital Profile</a></li>
                        <li><a href="profile-edit.html"><i class="ri-file-edit-fill"></i> Edit Hospital</a></li>
                    </ul>
                </li>
                <li>
                    <a href="#pharmacy-info" class="iq-waves-effect collapsed" data-toggle="collapse"
                       aria-expanded="false"><i class="ri-user-3-fill"></i><span>Pharmacy</span><i
                                class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                    <ul id="pharmacy-info" class="iq-submenu collapse bg-white" data-parent="#iq-sidebar-toggle">
                        <li><a href="/ListPharmacy"><i class="ri-file-list-fill"></i>List Pharmacy</a></li>
                        <li><a href="add-Pharmacy.html"><i class="ri-user-add-fill"></i> Add Pharmacy</a></li>
                        <li><a href="profile.html"><i class="ri-profile-fill"></i>Pharmacy Profile</a></li>
                        <li><a href="profile-edit.html"><i class="ri-file-edit-fill"></i> Edit Pharmacy</a></li>
                    </ul>
                </li>
                <li>
                    <a href="#doctor-info" class="iq-waves-effect collapsed" data-toggle="collapse"
                       aria-expanded="false"><i class="ri-user-3-fill"></i><span>Doctors</span><i
                                class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                    <ul id="doctor-info" class="iq-submenu collapse bg-white" data-parent="#iq-sidebar-toggle">
                        <li><a href="ListDoctor"><i class="ri-file-list-fill"></i>List Doctor</a></li>
                ...
                <li><a href="chat.php" class="iq-waves-effect"><i class="ri-message-fill"></i><span>Chat</span></a>
                </li>
                ...
                <li>
                    ...
                    <ul id="ui-elements" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        ...
                        <li><a href="ui-notifications.html"><i class="ri-notification-3-fill"></i>Notifications</a>
                        </li>
                ...
                <li>
                    ...
                    <ul id="forms-wizard" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        ...
                        <li><a href="form-wizard-validate.html"><i class="ri-anticlockwise-2-fill"></i>Validate
                                Wizard</a></li>
                        <li><a href="form-wizard-vertical.html"><i class="ri-clockwise-fill"></i>Vertical Wizard</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#tables" class="iq-waves-effect collapsed" data-toggle="collapse"
                       aria-expanded="false"><i class="ri-table-fill"></i><span>Table</span><i
                                class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                    <ul id="tables" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        ...
                        <li><a href="table-editable.html"><i class="ri-archive-drawer-fill"></i>Editable Table</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#charts" class="iq-waves-effect collapsed" data-toggle="collapse"
                       aria-expanded="false"><i class="ri-bar-chart-2-fill"></i><span>Charts</span><i
                                class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                ...
                <li>
                    ...
                    <ul id="authentication" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        ...
                        <li><a href="pages-recoverpw.html"><i class="ri-record-mail-fill"></i>Recover Password</a>
                        </li>
                ...
                <li>
                    ...
                    <ul id="extra-pages" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        ...
                        <li><a href="pages-maintenance.html"><i
                                        class="ri-git-repository-commits-fill"></i>Maintenance</a>
                        </li>
