        ...
        <div id="sidebar-scrollbar">
            <nav class="iq-sidebar-menu">
                <ul id="iq-sidebar-toggle" class="iq-menu">
                    ...
                    <li class="active">
                        <a href="index.php" class="iq-waves-effect"><i class="ri-hospital-fill"></i><span>Minstry of Health</span></a>
                    </li>
                    <li>
                        <a href="pharma.php" class="iq-waves-effect"><i class="ri-pulse-fill"></i><span>Pharmacy</span></a>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul id="mailbox" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            <li><a href="app/index.php"><i class="ri-inbox-fill"></i>Inbox</a></li>
                            <li><a href="app/email-compose.php"><i class="ri-edit-2-fill"></i>Email Compose</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="doctor-info" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            <li><a href="doctor-list.php"><i class="ri-file-list-fill"></i>All Doctors</a></li>
                            <li><a href="add-doctor.php"><i class="ri-user-add-fill"></i> Add Doctor</a></li>
                            <li><a href="profile.php"><i class="ri-profile-fill"></i>Doctor Profile</a></li>
                            <li><a href="profile-edit.php"><i class="ri-file-edit-fill"></i> Edit Doctor</a></li>
                        </ul>
                    </li>
                    <li><a href="calendar.php" class="iq-waves-effect"><i class="ri-calendar-event-fill"></i><span>Calendar</span></a></li>

                    <li><a href="chat.php" class="iq-waves-effect"><i class="ri-message-fill"></i><span>Chat</span></a></li>
