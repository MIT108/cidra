...
if (jQuery('#am-simple-chart').length) {
    am4core.ready(function() {
        ...
        http.open('GET', 'php/first.php?hospitalStat=1')
        http.send()
        http.onreadystatechange = async function(){
            if (http.readyState === 4 && http.status == 200){
                console.log(http.responseText)

                let stat = await JSON.parse(http.responseText)
                console.log(stat)
                if (stat.length > 0){
        ...
        // var mit = [10,100, 102, 200, 500, 300,0,300, 700,400];


    }); // end am4core.ready()
}
if (jQuery('#am-simple-chartb').length) {
    am4core.ready(function() {
        ...
        // Create chart instance
        var chart = am4core.create("am-simple-chartb", am4charts.XYChart);
        chart.colors.list = [am4core.color("#089bab"), ];


        var http=new XMLHttpRequest()
        http.open('GET', 'php/first.php?pharmaStat=1')
        http.send()
        http.onreadystatechange = async function(){
            if (http.readyState === 4 && http.status == 200){
                console.log(http.responseText)
...
if (jQuery("#home-chart-03b").length) {
    am4core.ready(function() {
        ...
        var chart = am4core.create("home-chart-03b", am4charts.PieChart);
        chart.hiddenState.properties.opacity = 0;
